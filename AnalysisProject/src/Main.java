...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		songGenerator Chorusgenerator = new songGenerator(chorus);
		...
		songGenerator Quavogenerator = new songGenerator(quavo);
		...
		songGenerator Offsetgenerator = new songGenerator(offset);
		...
		songGenerator Takeoffgenerator = new songGenerator(takeoff);
